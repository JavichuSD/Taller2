...
import javax.swing.*;
import taller2.Vendedor;
import taller2.Venta;
import taller2.VentaDAO;
...
public class RegistrarVenta extends JFrame{
    ...
    private void registrarVentaButton(ActionEvent e) {
        ...
        int monto = Integer.parseInt(montoTf.getText()); //parse el string a entero
        Venta v =  new Venta(fecha, WIDTH, monto, sucursal);
    ...
    private void initComponents() {
        ...
        vendedorCb.addItem(new Vendedor(4, "Gabriel", "Duarte", "13.123.333-4"));
